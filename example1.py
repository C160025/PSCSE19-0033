...
def color_transfer(source, target, clip=True, preserve_paper=True):
    ...
    # subtract the means from the source image instead of target source
...
transfer_path = "images/source2_target2.png"
source = cv2.imread(source_path, cv2.IMREAD_COLOR)
target = cv2.imread(target_path, cv2.IMREAD_COLOR)
transfer_bgr = color_transfer(source, target, clip=True, preserve_paper=True)
